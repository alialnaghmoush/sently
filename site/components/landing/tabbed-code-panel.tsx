 ...
 * footer copy with the snippet. A sender → transport → channel route strip
 * under the panel relays a packet in the active channel's ink. Reduced
 * motion: no auto-cycle, no settle, instant tab swaps, static route strip.
 */
...
import { HeroTransportRoute } from "@/components/landing/hero-transport-route";
...
export type CodeTourTab = {
  ...
  /** Transport class the snippet constructs — feeds the route strip. */
  ...
  return (
    <MotionConfig reducedMotion="never">
      <div className="flex w-full min-w-0 flex-col gap-3">
        ...
        {/* Transport route strip — mirrors the signal map under the hero copy */}
        {active.transport && meta ? (
          <motion.div
            aria-hidden
            ...
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                <HeroTransportRoute
                  ...
                  channel={meta.label.toUpperCase()}
                  ink={meta.ink}
                />
              </motion.div>
            </AnimatePresence>
