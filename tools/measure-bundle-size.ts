...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    category: "stack",
    label: "HTTP — SNDR",
    description: "`sently/mailer` + `sently/transports/sndr`",
    code: `import { createMailer } from "../src/mailer.ts"; import { SndrTransport } from "../src/transports/sndr.ts"; export const keep = async () => createMailer({ transport: new SndrTransport({ apiKey: "x" }) });`,
  },
  {
  ...
  },
  {
    ...
    category: "core",
    label: "sently/sms",
    description: "Channel sender `createSmsSender`",
    code: `import { createSmsSender } from "../src/sms.ts"; export const keep = createSmsSender;`,
  },
  {
    id: "sently/whatsapp",
    category: "core",
    label: "sently/whatsapp",
    description: "Channel sender `createWhatsAppSender`",
    code: `import { createWhatsAppSender } from "../src/whatsapp.ts"; export const keep = createWhatsAppSender;`,
  },
  {
    id: "sently/push",
    category: "core",
    label: "sently/push",
    description: "Channel sender `createPushSender`",
    code: `import { createPushSender } from "../src/push.ts"; export const keep = createPushSender;`,
  },
  {
    id: "sently/smtp",
    category: "core",
  ...
  },
  {
    id: "sently/webhooks",
    category: "optional",
    label: "sently/webhooks (named)",
    description: "Barrel named import — bundlers tree-shake unused parsers",
    code: `import { parseResendWebhook } from "../src/webhooks.ts"; export const keep = parseResendWebhook;`,
    budget: false,
  },
  {
    id: "sently/webhooks/sndr",
    category: "optional",
    label: "sently/webhooks/sndr",
    description: "Per-provider webhook subpath (smallest Node/Deno graph)",
    code: `import { parse, verifySignature } from "../src/webhooks/sndr.ts"; export const keep = { parse, verifySignature };`,
  },
  // ─── Transports ───
  {
  ...
  {
    id: "sently/transports/mailersend",
    category: "transport",
    label: "transports/mailersend",
    description: "MailerSend HTTP API",
    code: `import { MailerSendTransport } from "../src/transports/mailersend.ts"; export const keep = MailerSendTransport;`,
  },
  {
    id: "sently/transports/plunk",
    category: "transport",
    label: "transports/plunk",
    description: "Plunk HTTP API",
    code: `import { PlunkTransport } from "../src/transports/plunk.ts"; export const keep = PlunkTransport;`,
  },
  {
    id: "sently/transports/sparkpost",
    category: "transport",
    label: "transports/sparkpost",
    description: "SparkPost HTTP API",
    code: `import { SparkPostTransport } from "../src/transports/sparkpost.ts"; export const keep = SparkPostTransport;`,
  },
  {
    id: "sently/transports/mailtrap",
    category: "transport",
    label: "transports/mailtrap",
    description: "Mailtrap HTTP API",
  ...
  },
  {
    ...
    description: "Loops transactional HTTP API",
    code: `import { LoopsTransport } from "../src/transports/loops.ts"; export const keep = LoopsTransport;`,
  },
  {
    id: "sently/transports/sndr",
    category: "transport",
    label: "transports/sndr",
    description: "SNDR HTTP API",
    code: `import { SndrTransport } from "../src/transports/sndr.ts"; export const keep = SndrTransport;`,
  },
  {
    id: "sently/observability",
    category: "optional",
    label: "sently/observability",
    description: "consoleObserver hooks",
    code: `import { consoleObserver } from "../src/observability/console.ts"; export const keep = consoleObserver;`,
  },
  {
    id: "sently/transports/twilio-sms",
    category: "transport",
    label: "transports/twilio-sms",
    description: "Twilio SMS Messages API",
    code: `import { TwilioSmsTransport } from "../src/transports/twilio-sms.ts"; export const keep = TwilioSmsTransport;`,
  },
  {
    id: "sently/transports/taqnyat-sms",
    category: "transport",
    label: "transports/taqnyat-sms",
    description: "Taqnyat SMS API + Verify OTP helpers",
    code: `import { TaqnyatSmsTransport } from "../src/transports/taqnyat-sms.ts"; export const keep = TaqnyatSmsTransport;`,
  },
  {
    id: "sently/transports/taqnyat-whatsapp",
    category: "transport",
    label: "transports/taqnyat-whatsapp",
    description: "Taqnyat WhatsApp Business API",
    code: `import { TaqnyatWhatsAppTransport } from "../src/transports/taqnyat-whatsapp.ts"; export const keep = TaqnyatWhatsAppTransport;`,
  },
  {
    id: "sently/transports/taqnyat-mail",
    category: "transport",
    label: "transports/taqnyat-mail",
    description: "Taqnyat Email API",
    code: `import { TaqnyatMailTransport } from "../src/transports/taqnyat-mail.ts"; export const keep = TaqnyatMailTransport;`,
  },
  {
    id: "sently/transports/msegat",
    category: "transport",
    label: "transports/msegat",
    description: "Msegat SMS gateway",
  ...
  },
  {
    ...
    code: `import { WhatsAppCloudTransport } from "../src/transports/whatsapp-cloud.ts"; export const keep = WhatsAppCloudTransport;`,
  },
  {
    id: "sently/transports/webpush",
    category: "transport",
